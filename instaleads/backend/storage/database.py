    ...
    async with aiosqlite.connect(_db_path) as db:
        await db.executescript("""
            ...
            CREATE TABLE IF NOT EXISTS ig_scrape_jobs (
                ...
                discovery_google INTEGER DEFAULT 0,
                discovery_duckduckgo INTEGER DEFAULT 0,
                discovery_hashtag_api INTEGER DEFAULT 0,
                discovery_location_api INTEGER DEFAULT 0,
                discovery_fallback INTEGER DEFAULT 0,
                profile_fetch_failures INTEGER DEFAULT 0,
...
async def update_job_fields(job_id: str, **fields: object) -> None:
    allowed = {
        ...
        "skipped_private",
        "discovery_google",
        "discovery_duckduckgo",
        "discovery_hashtag_api",
        "discovery_location_api",
        "discovery_fallback",
